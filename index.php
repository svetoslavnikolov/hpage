...
$bottom_text="";
$page_icon="http://server.elektro.dtu.dk/personal/sn/hpage/.pictures/hpage_icon.ico";
$print_icon="http://server.elektro.dtu.dk/personal/sn/hpage/.pictures/printer.gif";

$home_text="Home";
$bottom_text="Created with <a class=\"banner\" href=\"http://www.elektro.dtu.dk/personal/sn/hpage/\">H-Page</a>\n";
...
if (strlen($_SERVER['SCRIPT_URL'])>0)
	$rel_path = $_SERVER['SCRIPT_URL'];
elseif(strlen($_SERVER['SCRIPT_URL'])>0)
	$rel_path = $_SERVER['REDIRECT_URL'];
else
    $rel_path = $_SERVER['SCRIPT_NAME'];
...
$css_link = "http://server.elektro.dtu.dk/personal/sn/styles/green.css";
$css_print_link = "http://server.elektro.dtu.dk/personal/sn/styles/print.css";

$show_date = 0;
$page_look = "dtu";

$upperleft_html="<img height=20 src=\"http://server.elektro.dtu.dk/images/billede_tv.gif\" width=151 border=0 alt=\"design element\">";
...
$middleleft_html="<a href=\"http://server.elektro.dtu.dk/gallery/image0104big.jpg\" target=\"_blank\"><img src=\"http://oersted.dtu.dk/gallery/image0104.jpg\" width=151 height=72 alt=\"Image 104\" border=\"0\"></a>";
$middleright_html="<a href=\"http://server.elektro.dtu.dk/\"><img height=72 src=\"http://server.elektro.dtu.dk/images/orsted-dtu.gif\" width=600 border=0 alt=\"Oersted DTU\"></a>";
...
{
	$cmd="full_view";
	$css="http://server.elektro.dtu.dk/personal/sn/snstyles/pub_blue.css";
	$order="year";
	$fmt="html";
	$b = 1;
	$e=1;
   ...
   if ($year=="all") $year="";
	...
	$dblink = "http://server.elektro.dtu.dk/publications/personal/showbasket.php?";
	$dblink .= 'cmd=' . $cmd;
	$dblink .= '&id=' . $user_id;
	$dblink .= '&title=' . $title;
	$dblink .= '&header=';
